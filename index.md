...
### All Files
  ...
  <h3 id="agency">agency.txt</h3>
   Trip Planners     Human Readability / Timetables / Planning and Analysis
  15.  **agency_id** should be included, even if there is only one agency in the feed. (See also: recommendation to include agency_id in routes.txt and fare_attributes.txt.)
  16.  **agency_lang** field should be included.
  17.  **agency_phone** should be included unless no such customer service phone exists.
  18.  **agency_email** should be included unless no such customer service email exists.
  19.  **agency_fare_url** should be included unless the agency is fully fare-free, and fare_attributes.txt is included to indicate that the system is fare-free.
  <h3 id="feed-info">feed_info.txt</h3>
   Trip Planners     Human Readability
  20.  feed_info.txt should be included, with all fields, below.
  21.  feed_publisher_name
  22.  feed_publisher_url
  23.  feed_lang
  24.  Ffeed_start_date
   and feed_end_date. It is recommended to pay particular attention to this sentence from the Specification, “If feed_start_date or feed_end_date extend beyond the active calendar dates defined in calendar.txt and calendar_dates.txt, the feed is making an explicit assertion that there is no service for dates within the feed_start_date or feed_end_date range but not included in the active calendar dates.”
  25.  feed_version
