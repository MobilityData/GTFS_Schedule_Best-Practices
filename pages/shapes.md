...
table_data:
  - field_name: "All Fields"
    recommendations:
      - ID: 1
        ...
        text: "Ideally, for alignments that are shared (i.e. in a case where Routes 1 and 2 operate on the same segment of roadway or track) then the shared portion of alignment should match exactly. This helps to facilitate high-quality transit cartography. <!-- (77) -->"
      - ID: 2
        tags: []
        text: |
  ...
  - field_name: shape_dist_traveled
    recommendations:
      - ID: 3
        tags: []
        text: "Must be provided in both `shapes.txt` and `stop_times.txt` if an alignment includes looping or inlining (the vehicle crosses or travels over the same portion of alignment in one trip). <!-- (79) -->"
        example_table: |
